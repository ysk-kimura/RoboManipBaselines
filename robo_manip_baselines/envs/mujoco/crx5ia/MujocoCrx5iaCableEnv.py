...
from .MujocoCrx5iaEnvBase import MujocoCrx5iaEnvBase


class MujocoCrx5iaCableEnv(MujocoCrx5iaEnvBase):
    def __init__(
        self,
        **kwargs,
    ):
        MujocoCrx5iaEnvBase.__init__(
            self,
            path.join(
                path.dirname(__file__),
                "../../assets/mujoco/envs/crx5ia/env_crx5ia_cable.xml",
            ),
            np.array(
                [
                    0,
