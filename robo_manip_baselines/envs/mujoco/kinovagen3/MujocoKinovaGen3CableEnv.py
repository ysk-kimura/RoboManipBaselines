...
from .MujocoKinovaGen3EnvBase import MujocoKinovaGen3EnvBase


class MujocoKinovaGen3CableEnv(MujocoKinovaGen3EnvBase):
    def __init__(
        self,
        **kwargs,
    ):
        MujocoKinovaGen3EnvBase.__init__(
            self,
            path.join(
                path.dirname(__file__),
                "../../assets/mujoco/envs/kinovagen3/env_kinovagen3_cable.xml",
            ),
            np.array(
                [
                    0,
