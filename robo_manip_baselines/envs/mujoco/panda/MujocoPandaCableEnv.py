...
from .MujocoPandaEnvBase import MujocoPandaEnvBase


class MujocoPandaCableEnv(MujocoPandaEnvBase):
    def __init__(
        self,
        **kwargs,
    ):
        MujocoPandaEnvBase.__init__(
            self,
            path.join(
                path.dirname(__file__),
                "../../assets/mujoco/envs/panda/env_panda_cable.xml",
            ),
            np.array(
                [
                    0,
